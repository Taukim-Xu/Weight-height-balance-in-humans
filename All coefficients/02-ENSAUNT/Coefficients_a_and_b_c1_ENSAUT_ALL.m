...
% dataset
Age_ENSANUT_2006 = 1:85;
Coefficient_a_Female_1_ENSANUT_2006 = [];
Coefficient_b_Female_1_ENSANUT_2006 = [];
Coefficient_a_Male_1_ENSANUT_2006 = [];
Coefficient_b_Male_1_ENSANUT_2006 = [];
...
Coefficient_a_Female_1_ENSANUT_2006 = [Coefficient_a_Female_1_ENSANUT_2006 PP(2)];
Coefficient_b_Female_1_ENSANUT_2006 = [Coefficient_b_Female_1_ENSANUT_2006 PP(1)];
% Age 2
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_ENSANUT_2006 = [Coefficient_a_Male_1_ENSANUT_2006 PP(2)];
Coefficient_b_Male_1_ENSANUT_2006 = [Coefficient_b_Male_1_ENSANUT_2006 PP(1)];
% Age 2
...
% We calculate the coefficients of a and b in 1=a/Weight+b*Height for this
% dataset
Age_ENSANUT_2012 = 1:85;
Coefficient_a_Female_1_ENSANUT_2012 = [];
Coefficient_b_Female_1_ENSANUT_2012 = [];
Coefficient_a_Male_1_ENSANUT_2012 = [];
Coefficient_b_Male_1_ENSANUT_2012 = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_ENSANUT_2012 = [Coefficient_a_Female_1_ENSANUT_2012 PP(2)];
Coefficient_b_Female_1_ENSANUT_2012 = [Coefficient_b_Female_1_ENSANUT_2012 PP(1)];
% Age 2
X_data = (Female_data_2(:,1)/100).^c; % Height (m)
Y_data = Female_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_ENSANUT_2012 = [Coefficient_a_Male_1_ENSANUT_2012 PP(2)];
Coefficient_b_Male_1_ENSANUT_2012 = [Coefficient_b_Male_1_ENSANUT_2012 PP(1)];
% Age 2
X_data = (Male_data_2(:,1)/100).^c; % Height (m)
Y_data = Male_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
% We calculate the coefficients of a and b in 1=a/Weight+b*Height for this
% dataset
Age_ENSANUT_2016 = 1:80;
Coefficient_a_Female_1_ENSANUT_2016 = [];
Coefficient_b_Female_1_ENSANUT_2016 = [];
Coefficient_a_Male_1_ENSANUT_2016 = [];
Coefficient_b_Male_1_ENSANUT_2016 = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_ENSANUT_2016 = [Coefficient_a_Female_1_ENSANUT_2016 PP(2)];
Coefficient_b_Female_1_ENSANUT_2016 = [Coefficient_b_Female_1_ENSANUT_2016 PP(1)];
% Age 2
X_data = (Female_data_2(:,1)/100).^c; % Height (m)
Y_data = Female_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_ENSANUT_2016 = [Coefficient_a_Male_1_ENSANUT_2016 PP(2)];
Coefficient_b_Male_1_ENSANUT_2016 = [Coefficient_b_Male_1_ENSANUT_2016 PP(1)];
% Age 2
X_data = (Male_data_2(:,1)/100).^c; % Height (m)
Y_data = Male_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
% We calculate the coefficients of a and b in 1=a/Weight+b*Height for this
% dataset
Age_ENSANUT_2018 = 1:59;
Coefficient_a_Female_1_ENSANUT_2018 = [];
Coefficient_b_Female_1_ENSANUT_2018 = [];
Coefficient_a_Male_1_ENSANUT_2018 = [];
Coefficient_b_Male_1_ENSANUT_2018 = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_ENSANUT_2018 = [Coefficient_a_Female_1_ENSANUT_2018 PP(2)];
Coefficient_b_Female_1_ENSANUT_2018 = [Coefficient_b_Female_1_ENSANUT_2018 PP(1)];
% Age 2
X_data = (Female_data_2(:,1)/100).^c; % Height (m)
Y_data = Female_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_ENSANUT_2018 = [Coefficient_a_Male_1_ENSANUT_2018 PP(2)];
Coefficient_b_Male_1_ENSANUT_2018 = [Coefficient_b_Male_1_ENSANUT_2018 PP(1)];
% Age 2
X_data = (Male_data_2(:,1)/100).^c; % Height (m)
Y_data = Male_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
% We calculate the coefficients of a and b in 1=a/Weight+b*Height for this
% dataset
Age_ENSANUT_100K_2018 = 1:80;
Coefficient_a_Female_1_ENSANUT_100K_2018 = [];
Coefficient_b_Female_1_ENSANUT_100K_2018 = [];
Coefficient_a_Male_1_ENSANUT_100K_2018 = [];
Coefficient_b_Male_1_ENSANUT_100K_2018 = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_ENSANUT_100K_2018 = [Coefficient_a_Female_1_ENSANUT_100K_2018 PP(2)];
Coefficient_b_Female_1_ENSANUT_100K_2018 = [Coefficient_b_Female_1_ENSANUT_100K_2018 PP(1)];
% Age 2
X_data = (Female_data_2(:,1)/100).^c; % Height (m)
Y_data = Female_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_ENSANUT_100K_2018 = [Coefficient_a_Male_1_ENSANUT_100K_2018 PP(2)];
Coefficient_b_Male_1_ENSANUT_100K_2018 = [Coefficient_b_Male_1_ENSANUT_100K_2018 PP(1)];
% Age 2
X_data = (Male_data_2(:,1)/100).^c; % Height (m)
Y_data = Male_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
% We calculate the coefficients of a and b in 1=a/Weight+b*Height for this
% dataset
Age_ENSANUT_ALL = 1:85;
Coefficient_a_Female_1_ENSANUT_ALL = [];
Coefficient_b_Female_1_ENSANUT_ALL = [];
Coefficient_a_Male_1_ENSANUT_ALL = [];
Coefficient_b_Male_1_ENSANUT_ALL = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_ENSANUT_ALL = [Coefficient_a_Female_1_ENSANUT_ALL PP(2)];
Coefficient_b_Female_1_ENSANUT_ALL = [Coefficient_b_Female_1_ENSANUT_ALL PP(1)];
% Age 2
X_data = (Female_data_2(:,1)/100).^c; % Height (m)
Y_data = Female_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_ENSANUT_ALL = [Coefficient_a_Male_1_ENSANUT_ALL PP(2)];
Coefficient_b_Male_1_ENSANUT_ALL = [Coefficient_b_Male_1_ENSANUT_ALL PP(1)];
% Age 2
X_data = (Male_data_2(:,1)/100).^c; % Height (m)
Y_data = Male_data_2(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
x_data = Age_ENSANUT_2006;
y_data = Coefficient_a_Female_1_ENSANUT_2006; % Female
HH1 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(1,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2012;
y_data = Coefficient_a_Female_1_ENSANUT_2012; % Female
HH2 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(2,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2016;
y_data = Coefficient_a_Female_1_ENSANUT_2016; % Female
HH3 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(3,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2018;
y_data = Coefficient_a_Female_1_ENSANUT_2018; % Female
HH4 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(4,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_100K_2018;
y_data = Coefficient_a_Female_1_ENSANUT_100K_2018; % Female
HH5 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(5,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_ALL;
y_data = Coefficient_a_Female_1_ENSANUT_ALL; % Female
HH6 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(6,:),'MarkerFaceColor','w');

Legend = legend([HH1 HH2 HH3 HH4 HH5 HH6],...
    'ENSANUT 2006','ENSANUT 2012','ENSANUT 2016','ENSANUT 2018','ENSANUT 100K 2018','ENSANUT ALL',...
    'Location','southwest');
set(Legend,'Box','off')
...
x_data = Age_ENSANUT_2006;
y_data = Coefficient_b_Female_1_ENSANUT_2006; % Female
HH1 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(1,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2012;
y_data = Coefficient_b_Female_1_ENSANUT_2012; % Female
HH2 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(2,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2016;
y_data = Coefficient_b_Female_1_ENSANUT_2016; % Female
HH3 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(3,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2018;
y_data = Coefficient_b_Female_1_ENSANUT_2018; % Female
HH4 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(4,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_100K_2018;
y_data = Coefficient_b_Female_1_ENSANUT_100K_2018; % Female
HH5 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(5,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_ALL;
y_data = Coefficient_b_Female_1_ENSANUT_ALL; % Female
HH6 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(6,:),'MarkerFaceColor','w');
...
x_data = Age_ENSANUT_2006;
y_data = Coefficient_a_Male_1_ENSANUT_2006; % Male
HH1 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(1,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2012;
y_data = Coefficient_a_Male_1_ENSANUT_2012; % Male
HH2 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(2,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2016;
y_data = Coefficient_a_Male_1_ENSANUT_2016; % Male
HH3 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(3,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2018;
y_data = Coefficient_a_Male_1_ENSANUT_2018; % Male
HH4 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(4,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_100K_2018;
y_data = Coefficient_a_Male_1_ENSANUT_100K_2018; % Male
HH5 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(5,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_ALL;
y_data = Coefficient_a_Male_1_ENSANUT_ALL; % Male
HH6 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(6,:),'MarkerFaceColor','w');
...
x_data = Age_ENSANUT_2006;
y_data = Coefficient_b_Male_1_ENSANUT_2006; % Male
HH1 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(1,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2012;
y_data = Coefficient_b_Male_1_ENSANUT_2012; % Male
HH2 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(2,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2016;
y_data = Coefficient_b_Male_1_ENSANUT_2016; % Male
HH3 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(3,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_2018;
y_data = Coefficient_b_Male_1_ENSANUT_2018; % Male
HH4 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(4,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_100K_2018;
y_data = Coefficient_b_Male_1_ENSANUT_100K_2018; % Male
HH5 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(5,:),'MarkerFaceColor','w');

x_data = Age_ENSANUT_ALL;
y_data = Coefficient_b_Male_1_ENSANUT_ALL; % Male
HH6 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize+1,'Color',My_Colors_7(6,:),'MarkerFaceColor','w');

% We save the coefficients a and b
save('Coefficients_a_and_b_c1_ENSAUT_ALL.mat',...
    'Age_ENSANUT_2006','Coefficient_a_Female_1_ENSANUT_2006','Coefficient_b_Female_1_ENSANUT_2006',...
    'Coefficient_a_Male_1_ENSANUT_2006','Coefficient_b_Male_1_ENSANUT_2006',...
    'Age_ENSANUT_2012','Coefficient_a_Female_1_ENSANUT_2012','Coefficient_b_Female_1_ENSANUT_2012',...
    'Coefficient_a_Male_1_ENSANUT_2012','Coefficient_b_Male_1_ENSANUT_2012',...
    'Age_ENSANUT_2016','Coefficient_a_Female_1_ENSANUT_2016','Coefficient_b_Female_1_ENSANUT_2016',...
    'Coefficient_a_Male_1_ENSANUT_2016','Coefficient_b_Male_1_ENSANUT_2016',...
    'Age_ENSANUT_2018','Coefficient_a_Female_1_ENSANUT_2018','Coefficient_b_Female_1_ENSANUT_2018',...
    'Coefficient_a_Male_1_ENSANUT_2018','Coefficient_b_Male_1_ENSANUT_2018',...
    'Age_ENSANUT_100K_2018','Coefficient_a_Female_1_ENSANUT_100K_2018','Coefficient_b_Female_1_ENSANUT_100K_2018',...
    'Coefficient_a_Male_1_ENSANUT_100K_2018','Coefficient_b_Male_1_ENSANUT_100K_2018',...
    'Age_ENSANUT_ALL','Coefficient_a_Female_1_ENSANUT_ALL','Coefficient_b_Female_1_ENSANUT_ALL',...
    'Coefficient_a_Male_1_ENSANUT_ALL','Coefficient_b_Male_1_ENSANUT_ALL');
