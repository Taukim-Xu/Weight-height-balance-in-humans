...
%% BCCPDS_7_21_China
% Raw data cannot be obtained, only the results of analysis can be provided
% Loading the data
...
save('Correlation_coefficient_c1_China.mat','Age_Jilin_China','Corr_Jilin_China_Female','Corr_Jilin_China_Male',...
    ...
    'Age_1_CHARLS','Corr_1_CHARLS_Female','Corr_1_CHARLS_Male');
