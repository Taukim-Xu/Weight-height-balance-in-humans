...
% all Eastern Europe datasets when exponent c = 1;
% Including:
% 57_Latvia - 拉脱维亚
% 48_Lithuania - 立陶宛
% 35_Estonia - 爱沙尼亚
...
%% 57_Latvia
% Loading the data
Female_data = xlsread('Data_Europe\57_Latvia.xlsx','Female');
Male_data = xlsread('Data_Europe\57_Latvia.xlsx','Male');
% Grouping by age
Female_data_51 = [];
Female_data_52 = [];
Female_data_53 = [];
...
% dataset
Age_57_Latvia = 51:86;
Coefficient_a_Female_1_57_Latvia = [];
Coefficient_b_Female_1_57_Latvia = [];
Coefficient_a_Male_1_57_Latvia = [];
Coefficient_b_Male_1_57_Latvia = [];
...
Coefficient_a_Female_1_57_Latvia = [Coefficient_a_Female_1_57_Latvia PP(2)];
Coefficient_b_Female_1_57_Latvia = [Coefficient_b_Female_1_57_Latvia PP(1)];
% Age 52
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_57_Latvia = [Coefficient_a_Male_1_57_Latvia PP(2)];
Coefficient_b_Male_1_57_Latvia = [Coefficient_b_Male_1_57_Latvia PP(1)];
% Age 52
...
%% 48_Lithuania
% Loading the data
Female_data = xlsread('Data_Europe\48_Lithuania.xlsx','Female');
Male_data = xlsread('Data_Europe\48_Lithuania.xlsx','Male');
% Grouping by age
Female_data_51 = [];
Female_data_52 = [];
Female_data_53 = [];
...
Coefficient_a_Female_1_48_Lithuania = [];
Coefficient_b_Female_1_48_Lithuania = [];
Coefficient_a_Male_1_48_Lithuania = [];
Coefficient_b_Male_1_48_Lithuania = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_48_Lithuania = [Coefficient_a_Female_1_48_Lithuania PP(2)];
Coefficient_b_Female_1_48_Lithuania = [Coefficient_b_Female_1_48_Lithuania PP(1)];
% Age 52
X_data = (Female_data_52(:,1)/100).^c; % Height (m)
Y_data = Female_data_52(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_48_Lithuania = [Coefficient_a_Male_1_48_Lithuania PP(2)];
Coefficient_b_Male_1_48_Lithuania = [Coefficient_b_Male_1_48_Lithuania PP(1)];
% Age 52
X_data = (Male_data_52(:,1)/100).^c; % Height (m)
Y_data = Male_data_52(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
%% 35_Estonia
% Loading the data
Female_data = xlsread('Data_Europe\35_Estonia.xlsx','Female');
Male_data = xlsread('Data_Europe\35_Estonia.xlsx','Male');
% Grouping by age
Female_data_50 = []; % <= 50
Female_data_51 = [];
Female_data_52 = [];
...
Coefficient_a_Female_1_35_Estonia = [];
Coefficient_b_Female_1_35_Estonia = [];
Coefficient_a_Male_1_35_Estonia = [];
Coefficient_b_Male_1_35_Estonia = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_35_Estonia = [Coefficient_a_Female_1_35_Estonia PP(2)];
Coefficient_b_Female_1_35_Estonia = [Coefficient_b_Female_1_35_Estonia PP(1)];
% Age 51
X_data = (Female_data_51(:,1)/100).^c; % Height (m)
Y_data = Female_data_51(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_35_Estonia = [Coefficient_a_Male_1_35_Estonia PP(2)];
Coefficient_b_Male_1_35_Estonia = [Coefficient_b_Male_1_35_Estonia PP(1)];
% Age 51
X_data = (Male_data_51(:,1)/100).^c; % Height (m)
Y_data = Male_data_51(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
save('Coefficients_a_and_b_c1_Eastern_Europe.mat',...
    'Age_57_Latvia','Coefficient_a_Female_1_57_Latvia','Coefficient_b_Female_1_57_Latvia',...
    'Coefficient_a_Male_1_57_Latvia','Coefficient_b_Male_1_57_Latvia',...
    'Age_48_Lithuania','Coefficient_a_Female_1_48_Lithuania','Coefficient_b_Female_1_48_Lithuania',...
    'Coefficient_a_Male_1_48_Lithuania','Coefficient_b_Male_1_48_Lithuania',...
    'Age_35_Estonia','Coefficient_a_Female_1_35_Estonia','Coefficient_b_Female_1_35_Estonia',...
    'Coefficient_a_Male_1_35_Estonia','Coefficient_b_Male_1_35_Estonia');
