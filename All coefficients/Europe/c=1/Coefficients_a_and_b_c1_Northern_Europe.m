...
% all Northern Europe datasets when exponent c = 1;
% Including:
% 13_Sweden - 瑞典
% 18_Denmark - 丹麦
%
...
%% 13_Sweden
% Loading the data
Female_data = xlsread('Data_Europe\13_Sweden.xlsx','Female');
Male_data = xlsread('Data_Europe\13_Sweden.xlsx','Male');
% Grouping by age
Female_data_50 = []; % <= 50
Female_data_51 = [];
Female_data_52 = [];
...
% dataset
Age_13_Sweden = 50:90;
Coefficient_a_Female_1_13_Sweden = [];
Coefficient_b_Female_1_13_Sweden = [];
Coefficient_a_Male_1_13_Sweden = [];
Coefficient_b_Male_1_13_Sweden = [];
...
Coefficient_a_Female_1_13_Sweden = [Coefficient_a_Female_1_13_Sweden PP(2)];
Coefficient_b_Female_1_13_Sweden = [Coefficient_b_Female_1_13_Sweden PP(1)];
% Age 51
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_13_Sweden = [Coefficient_a_Male_1_13_Sweden PP(2)];
Coefficient_b_Male_1_13_Sweden = [Coefficient_b_Male_1_13_Sweden PP(1)];
% Age 51
...
%% 18_Denmark
% Loading the data
Female_data = xlsread('Data_Europe\18_Denmark.xlsx','Female');
Male_data = xlsread('Data_Europe\18_Denmark.xlsx','Male');
% Grouping by age
Female_data_50 = []; % <= 50
Female_data_51 = [];
Female_data_52 = [];
...
Coefficient_a_Female_1_18_Denmark = [];
Coefficient_b_Female_1_18_Denmark = [];
Coefficient_a_Male_1_18_Denmark = [];
Coefficient_b_Male_1_18_Denmark = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_18_Denmark = [Coefficient_a_Female_1_18_Denmark PP(2)];
Coefficient_b_Female_1_18_Denmark = [Coefficient_b_Female_1_18_Denmark PP(1)];
% Age 51
X_data = (Female_data_51(:,1)/100).^c; % Height (m)
Y_data = Female_data_51(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_18_Denmark = [Coefficient_a_Male_1_18_Denmark PP(2)];
Coefficient_b_Male_1_18_Denmark = [Coefficient_b_Male_1_18_Denmark PP(1)];
% Age 51
X_data = (Male_data_51(:,1)/100).^c; % Height (m)
Y_data = Male_data_51(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
save('Coefficients_a_and_b_c1_Northern_Europe.mat',...
    'Age_13_Sweden','Coefficient_a_Female_1_13_Sweden','Coefficient_b_Female_1_13_Sweden',...
    'Coefficient_a_Male_1_13_Sweden','Coefficient_b_Male_1_13_Sweden',...
    'Age_18_Denmark','Coefficient_a_Female_1_18_Denmark','Coefficient_b_Female_1_18_Denmark',...
    'Coefficient_a_Male_1_18_Denmark','Coefficient_b_Male_1_18_Denmark');
