%% Source codes for Extended Data Table 4
...
Female_data = xlsread('Raw_data\Data_Asia\KSPF, Korea.xlsx','Female');
Male_data = xlsread('Raw_data\Data_Asia\KSPF, Korea.xlsx','Male');
...
% Age 1
Coefficient_a_Female_1_KSPF_Korea = [Coefficient_a_Female_1_KSPF_Korea 0];
Coefficient_b_Female_1_KSPF_Korea = [Coefficient_b_Female_1_KSPF_Korea 0];
% Age 2
Coefficient_a_Female_1_KSPF_Korea = [Coefficient_a_Female_1_KSPF_Korea 0];
Coefficient_b_Female_1_KSPF_Korea = [Coefficient_b_Female_1_KSPF_Korea 0];
% Age 3
...
Save_data = [Save_data;Age;Coefficient_a_Female_1_KSPF_Korea;Coefficient_b_Female_1_KSPF_Korea];
...
% Age 1
Coefficient_a_Male_1_KSPF_Korea = [Coefficient_a_Male_1_KSPF_Korea 0];
Coefficient_b_Male_1_KSPF_Korea = [Coefficient_b_Male_1_KSPF_Korea 0];
% Age 2
Coefficient_a_Male_1_KSPF_Korea = [Coefficient_a_Male_1_KSPF_Korea 0];
Coefficient_b_Male_1_KSPF_Korea = [Coefficient_b_Male_1_KSPF_Korea 0];
% Age 3
...
Save_data = [Save_data;Age;Coefficient_a_Male_1_KSPF_Korea;Coefficient_b_Male_1_KSPF_Korea];
...
%% Japanese_1_8
% Data source: https://wwwn.cdc.gov/nchs/nhanes/default.aspx
Female_data = xlsread('Raw_data\Data_Asia\Japanese_1_8.xlsx','Female');
Male_data = xlsread('Raw_data\Data_Asia\Japanese_1_8.xlsx','Male');
% Stratified by age and gender
Female_data_1 = [];
Female_data_2 = [];
Female_data_3 = [];
...
Save_data = [Save_data;Age;Coefficient_a_Female_1_Japanese_1_8;Coefficient_b_Female_1_Japanese_1_8];
...
Save_data = [Save_data;Age;Coefficient_a_Male_1_Japanese_1_8;Coefficient_b_Male_1_Japanese_1_8];

%% China
Female_data = [];
Male_data = [];
Female_data_temp = xlsread('Raw_data\Data_Asia\Jilin_China.xlsx','Female');
Male_data_temp = xlsread('Raw_data\Data_Asia\Jilin_China.xlsx','Male');
Female_data = [Female_data;Female_data_temp];
Male_data = [Male_data;Male_data_temp];
Female_data_temp = xlsread('Raw_data\Data_Asia\Chongqing_6_21_China.xlsx','Female');
Male_data_temp = xlsread('Raw_data\Data_Asia\Chongqing_6_21_China.xlsx','Male');
Female_data = [Female_data;Female_data_temp];
Male_data = [Male_data;Male_data_temp];
Female_data_temp = xlsread('Raw_data\Data_Asia\BCCPDS_7_21_China.xlsx','Female');
Male_data_temp = xlsread('Raw_data\Data_Asia\BCCPDS_7_21_China.xlsx','Male');
Female_data = [Female_data;Female_data_temp];
Male_data = [Male_data;Male_data_temp];
% Stratified by age and gender
Female_data_6 = [];
...
% Age: 1:20
Age = 1:20;
Coefficient_a_Female_1_China = [];
Coefficient_b_Female_1_China = [];
% Age 1
Coefficient_a_Female_1_China = [Coefficient_a_Female_1_China 0];
Coefficient_b_Female_1_China = [Coefficient_b_Female_1_China 0];
% Age 2
Coefficient_a_Female_1_China = [Coefficient_a_Female_1_China 0];
Coefficient_b_Female_1_China = [Coefficient_b_Female_1_China 0];
% Age 3
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_China = [Coefficient_a_Female_1_China PP(2)];
Coefficient_b_Female_1_China = [Coefficient_b_Female_1_China PP(1)];
% Age 7
X_data = (Female_data_7(:,1)/100).^c; % Height (m)
Y_data = Female_data_7(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Save_data = [Save_data;Age;Coefficient_a_Female_1_China;Coefficient_b_Female_1_China];
...
% Age: 1:20
Age = 1:20;
Coefficient_a_Male_1_China = [];
Coefficient_b_Male_1_China = [];
% Age 1
Coefficient_a_Male_1_China = [Coefficient_a_Male_1_China 0];
Coefficient_b_Male_1_China = [Coefficient_b_Male_1_China 0];
% Age 2
Coefficient_a_Male_1_China = [Coefficient_a_Male_1_China 0];
Coefficient_b_Male_1_China = [Coefficient_b_Male_1_China 0];
% Age 3
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_China = [Coefficient_a_Male_1_China PP(2)];
Coefficient_b_Male_1_China = [Coefficient_b_Male_1_China PP(1)];
% Age 7
X_data = (Male_data_7(:,1)/100).^c; % Height (m)
Y_data = Male_data_7(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Save_data = [Save_data;Age;Coefficient_a_Male_1_China;Coefficient_b_Male_1_China];
...
%% 25_Israel
% Data source: https://wwwn.cdc.gov/nchs/nhanes/default.aspx
Female_data = xlsread('Raw_data\Data_Asia\25_Israel.xlsx','Female');
Male_data = xlsread('Raw_data\Data_Asia\25_Israel.xlsx','Male');
% Stratified by age and gender
Female_data_50 = [];
Female_data_51 = [];
Female_data_52 = [];
...
% Age 41
Coefficient_a_Female_1_25_Israel = [Coefficient_a_Female_1_25_Israel 0];
Coefficient_b_Female_1_25_Israel = [Coefficient_b_Female_1_25_Israel 0];
% Age 42
Coefficient_a_Female_1_25_Israel = [Coefficient_a_Female_1_25_Israel 0];
Coefficient_b_Female_1_25_Israel = [Coefficient_b_Female_1_25_Israel 0];
% Age 43
...
Save_data = [Save_data;Age;Coefficient_a_Female_1_25_Israel;Coefficient_b_Female_1_25_Israel];
...
% Age 41
Coefficient_a_Male_1_25_Israel = [Coefficient_a_Male_1_25_Israel 0];
Coefficient_b_Male_1_25_Israel = [Coefficient_b_Male_1_25_Israel 0];
% Age 42
Coefficient_a_Male_1_25_Israel = [Coefficient_a_Male_1_25_Israel 0];
Coefficient_b_Male_1_25_Israel = [Coefficient_b_Male_1_25_Israel 0];
% Age 43
...
Save_data = [Save_data;Age;Coefficient_a_Male_1_25_Israel;Coefficient_b_Male_1_25_Israel];
...
%% Bangladesh_2011_14
% Data source: https://wwwn.cdc.gov/nchs/nhanes/default.aspx
Female_data = xlsread('Raw_data\Data_Asia\Bangladesh_2011_14.xlsx','Female');
% Stratified by age and gender
Female_data_10 = [];
Female_data_11 = [];
Female_data_12 = [];
...
% Age: 1:20
Age = 1:20;
Coefficient_a_Female_1_Bangladesh = [];
Coefficient_b_Female_1_Bangladesh = [];
% Age 1
Coefficient_a_Female_1_Bangladesh = [Coefficient_a_Female_1_Bangladesh 0];
Coefficient_b_Female_1_Bangladesh = [Coefficient_b_Female_1_Bangladesh 0];
% Age 2
Coefficient_a_Female_1_Bangladesh = [Coefficient_a_Female_1_Bangladesh 0];
Coefficient_b_Female_1_Bangladesh = [Coefficient_b_Female_1_Bangladesh 0];
% Age 3
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_Bangladesh = [Coefficient_a_Female_1_Bangladesh PP(2)];
Coefficient_b_Female_1_Bangladesh = [Coefficient_b_Female_1_Bangladesh PP(1)];
% Age 12
X_data = (Female_data_12(:,1)/100).^c; % Height (m)
Y_data = Female_data_12(:,2); % Weight
Z_data= X_data.*Y_data; % Height^c*Weight
...
Save_data = [Save_data;Age;Coefficient_a_Female_1_Bangladesh;Coefficient_b_Female_1_Bangladesh];

%% We save the data
Save_data = round(Save_data,6);
xlswrite('Extended Data Table 4.xlsx',Save_data,'Sheet1','D2');
