%% Source codes for Extended Data Table 1
...
%% 
xlswrite('Extended Data Table 1.xlsx',Save_data_Female,'Sheet1','C3');
xlswrite('Extended Data Table 1.xlsx',Save_data_Male,'Sheet1','C7');
