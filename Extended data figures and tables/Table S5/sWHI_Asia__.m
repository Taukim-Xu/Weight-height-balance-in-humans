%% Source codes for sWHI_Asia__.mat
% For all Asian countries
% Using the raw Coefficienta a and b
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Female_Asia__ = [sWHI_Female_Asia__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
Age = 51;
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Male_Asia__ = [sWHI_Male_Asia__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
Age = 51;
...
%% We save the data
save sWHI_Asia__.mat sWHI_Female_Asia__ sWHI_Male_Asia__
