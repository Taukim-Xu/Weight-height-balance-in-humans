%% Source codes for Figure 1(D)
% c = 1
% only including (D)-Asian
%
...
HH1 = plot(x_data,y_data,'s','Markersize',My_MarkerSize,'Color',My_Colors_9(7,:),'LineWidth',My_LineWidth,'MarkerFaceColor','w');
...
% Legends
HH3 = plot([0 0],[-2 -2],'s','Markersize',My_MarkerSize,'Color',My_Colors_9(7,:),'LineWidth',My_LineWidth,'MarkerFaceColor','w'); % 03-Asian
...
save('Extended_Data_Fig_1_d.mat','My_Age_Female','My_5th_Female','My_50th_Female',...
