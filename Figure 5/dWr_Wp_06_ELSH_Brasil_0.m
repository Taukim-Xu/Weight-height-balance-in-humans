%% Source codes for dWr_Wp_06_ELSH_Brasil_0.m
tic;
%%
c = 1;
...
dWr_Wp_06_ELSH_Brasil_Female__25_50 = []; % 25<= Age < 50
dWr_Wp_06_ELSH_Brasil_Male__25_50 = []; % 25<= Age < 50
dWr_Wp_06_ELSH_Brasil_Female__50 = []; % Age >= 50
dWr_Wp_06_ELSH_Brasil_Male__50 = []; % Age >= 50
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_06_ELSH_Brasil_Female__25_50 = [dWr_Wp_06_ELSH_Brasil_Female__25_50 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 36;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_06_ELSH_Brasil_Female__50 = [dWr_Wp_06_ELSH_Brasil_Female__50 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 51;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_06_ELSH_Brasil_Male__25_50 = [dWr_Wp_06_ELSH_Brasil_Male__25_50 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 36;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_06_ELSH_Brasil_Male__50 = [dWr_Wp_06_ELSH_Brasil_Male__50 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 51;
...
toc;
%% We save the data
save dWr_Wp_06_ELSH_Brasil_0.mat dWr_Wp_06_ELSH_Brasil_Female__25_50 dWr_Wp_06_ELSH_Brasil_Male__25_50 ...
    dWr_Wp_06_ELSH_Brasil_Female__50 dWr_Wp_06_ELSH_Brasil_Male__50
