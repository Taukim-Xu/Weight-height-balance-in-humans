%% Source codes for dWr_Wp_03_KNHANES_0.m
tic;
%%
c = 1;
...
dWr_Wp_03_KNHANES_Female__25 = []; % Age < 25
dWr_Wp_03_KNHANES_Male__25 = []; % Age < 25
dWr_Wp_03_KNHANES_Female__25_50 = []; % 25<= Age < 50
dWr_Wp_03_KNHANES_Male__25_50 = []; % 25<= Age < 50
dWr_Wp_03_KNHANES_Female__50 = []; % Age >= 50
dWr_Wp_03_KNHANES_Male__50 = []; % Age >= 50
% Load and segment the data by age and gender
%% KNHANES_ALL
% KNHANES_ALL
Female_data = xlsread('./Raw data/03-KNHANES/KNHANES_ALL.xlsx','Female','B:D');
Male_data = xlsread('./Raw data/03-KNHANES/KNHANES_ALL.xlsx','Male','B:D');
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_03_KNHANES_Female__25 = [dWr_Wp_03_KNHANES_Female__25 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 2;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_03_KNHANES_Female__25_50 = [dWr_Wp_03_KNHANES_Female__25_50 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 26;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_03_KNHANES_Female__50 = [dWr_Wp_03_KNHANES_Female__50 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 51;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_03_KNHANES_Male__25 = [dWr_Wp_03_KNHANES_Male__25 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 2;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_03_KNHANES_Male__25_50 = [dWr_Wp_03_KNHANES_Male__25_50 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 26;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_03_KNHANES_Male__50 = [dWr_Wp_03_KNHANES_Male__50 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
% Age = 51;
...
toc;
%% We save the data
save dWr_Wp_03_KNHANES_0.mat dWr_Wp_03_KNHANES_Female__25 dWr_Wp_03_KNHANES_Male__25 ...
    dWr_Wp_03_KNHANES_Female__25_50 dWr_Wp_03_KNHANES_Male__25_50 ...
    dWr_Wp_03_KNHANES_Female__50 dWr_Wp_03_KNHANES_Male__50
