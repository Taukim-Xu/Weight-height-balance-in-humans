%% Source codes for dHr_Hp_06_ELSH_Brasil.m
tic;
%%
c = 1;
...
dHr_Hp_06_ELSH_Brasil_Female = []; % Wr - Wp: The real weight minus the weight predicted by the model
dHr_Hp_06_ELSH_Brasil_Male = []; % Wr - Wp: The real weight minus the weight predicted by the model
...
[M N] = size(X_Temp);
for i = 1:M
    dHr_Hp_06_ELSH_Brasil_Female = [dHr_Hp_06_ELSH_Brasil_Female X_Temp(i) - (Y_Temp(i)-Coefficient_a)/(Coefficient_b*Y_Temp(i))]; % Hr - Hp
end
% Age = 36;
...
[M N] = size(X_Temp);
for i = 1:M
    dHr_Hp_06_ELSH_Brasil_Male = [dHr_Hp_06_ELSH_Brasil_Male X_Temp(i) - (Y_Temp(i)-Coefficient_a)/(Coefficient_b*Y_Temp(i))]; % Hr - Hp
end
% Age = 36;
...
toc;
%% We save the data
save dHr_Hp_06_ELSH_Brasil.mat dHr_Hp_06_ELSH_Brasil_Female dHr_Hp_06_ELSH_Brasil_Male
