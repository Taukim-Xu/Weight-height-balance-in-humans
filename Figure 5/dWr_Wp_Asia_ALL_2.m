%% Source codes for dWr_Wp_Asia_ALL_2
% Age >= 50
tic;
%%
c = 1;
...
dWr_Wp_Asia_ALL_Female_2 = []; % Wr - Wp: The real weight minus the weight predicted by the model
dWr_Wp_Asia_ALL_Male_2 = []; % Wr - Wp: The real weight minus the weight predicted by the model
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_Asia_ALL_Female_2 = [dWr_Wp_Asia_ALL_Female_2 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
Age = 51;
...
[M N] = size(X_Temp);
for i = 1:M
    dWr_Wp_Asia_ALL_Male_2 = [dWr_Wp_Asia_ALL_Male_2 Y_Temp(i) - Coefficient_a/(1-Coefficient_b*X_Temp(i))]; % Wr - Wp
end
Age = 51;
...
%% We save the data
save dWr_Wp_Asia_ALL_2.mat dWr_Wp_Asia_ALL_Female_2 dWr_Wp_Asia_ALL_Male_2
%% We show the results
%% 
FF = figure;
