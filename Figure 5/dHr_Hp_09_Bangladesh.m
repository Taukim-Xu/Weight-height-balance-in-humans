%% Source codes for dHr_Hp_09_Bangladesh.m
tic;
%%
c = 1;
...
dHr_Hp_09_Bangladesh_Female = []; % Wr - Wp: The real weight minus the weight predicted by the model
...
[M N] = size(X_Temp);
for i = 1:M
    dHr_Hp_09_Bangladesh_Female = [dHr_Hp_09_Bangladesh_Female X_Temp(i) - (Y_Temp(i)-Coefficient_a)/(Coefficient_b*Y_Temp(i))]; % Hr - Hp
end
% Age = 11;
...
toc;
%% We save the data
save dHr_Hp_09_Bangladesh.mat dHr_Hp_09_Bangladesh_Female
