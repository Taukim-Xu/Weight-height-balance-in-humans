...
My_str_01 = ['r(W,W×H) = ' num2str(round(Corr_01,4))];
text(70,1.1,My_str_01,'FontName',My_FontName,'FontSize',My_fontSize)
...
My_str_02 = ['r(W,W×H) = ' num2str(round(Corr_02,4))];
text(70,1.1,My_str_02,'FontName',My_FontName,'FontSize',My_fontSize)
