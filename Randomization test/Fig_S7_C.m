...
%% Source codes for Fig. 7(C)
tic;
% Important Note: It took approximately 2900 seconds to run this code on the author's own computer.
%
%
...
Age = 1:90;
My_Percentile = [5 50 95]; % quantile distribution
Corr_Raw_All_Female = []; % the linear correlation coefficient between Weight and Weight*Height in the Raw data
Corr_Mean_Random_Female = []; % the mean values of linear correlation coefficient between Weight and Weight*Height across the random data
Corr_5th_Random_Female = []; % the 5th percentile of linear correlation coefficient between Weight and Weight*Height across the 1000 random data sets
Corr_95th_Random_Female = []; % the 95th percentile of linear correlation coefficient between Weight and Weight*Height across the 1000 random data sets

Corr_Raw_All_Male = []; % the linear correlation coefficient between Weight and Weight*Height in the Raw data
Corr_Mean_Random_Male = []; % the mean values of linear correlation coefficient between Weight and Weight*Height across the random data
Corr_5th_Random_Male = []; % the 5th percentile of linear correlation coefficient between Weight and Weight*Height across the 1000 random data sets
Corr_95th_Random_Male = []; % the 95th percentile of linear correlation coefficient between Weight and Weight*Height across the 1000 random data sets
...
Corr_Raw_All_Female = [Corr_Raw_All_Female Corr_Raw];
...
Corr_Mean_Random_Female = [Corr_Mean_Random_Female mean(Corr_random)];
Prctile_Female = prctile(Corr_random,My_Percentile);
Corr_5th_Random_Female = [Corr_5th_Random_Female Prctile_Female(1)]; % 5th percentile
Corr_95th_Random_Female = [Corr_95th_Random_Female Prctile_Female(3)]; % 95th percentile
...
Corr_Raw = My_Corr(Weight_pool,Weight_pool.*Height_pool);% The linear correlation coefficient between the Raw weight and weight*height
Corr_Raw_All_Male = [Corr_Raw_All_Male Corr_Raw];
[M N] = size(Height_pool);
% Randomly match the weight with the height in the Height pool for 1000
% times, while keeping the weight unchanged
Corr_random = zeros(1000,1);% the correlation between weight and weight * height after random matching.
...
Corr_Mean_Random_Male = [Corr_Mean_Random_Male mean(Corr_random)];
Prctile_Male = prctile(Corr_random,My_Percentile);
Corr_5th_Random_Male = [Corr_5th_Random_Male Prctile_Male(1)]; % 5th percentile
Corr_95th_Random_Male = [Corr_95th_Random_Male Prctile_Male(3)]; % 95th percentile
...
YY_Fill_1 = [Corr_5th_Random_Female,Corr_95th_Random_Female(end:-1:1)]; % 5th ~ 95th percentile range
HH_Fill_1 = fill(XX_Fill_1,YY_Fill_1,My_Colors_4_1(2,:));
set(HH_Fill_1,'edgealpha',Edgealpha,'facealpha',Alpha);

H1 = plot(Age,Corr_Mean_Random_Female,'LineWidth',My_LineWidth,'Color',My_Colors_4_1(2,:)); % mean of linear correlation coefficient accross the 1000 random data sets
H2 = plot(Age,Corr_Raw_All_Female,'LineWidth',My_LineWidth,'Color',My_Colors_4_1(1,:)); % linear correlation coefficient of the raw data sets

% Legend
Legend = legend([H1 H2],'Across the 1000 random data sets', 'The raw data','location','Southwest');
...
XX_Fill_1 = [Age,Age(end:-1:1)];
YY_Fill_1 = [Corr_5th_Random_Male,Corr_95th_Random_Male(end:-1:1)]; % 5th ~ 95th percentile range
HH_Fill_1 = fill(XX_Fill_1,YY_Fill_1,My_Colors_4_1(2,:));
set(HH_Fill_1,'edgealpha',Edgealpha,'facealpha',Alpha);

H1 = plot(Age,Corr_Mean_Random_Male,'LineWidth',My_LineWidth,'Color',My_Colors_4_1(2,:)); % mean of linear correlation coefficient accross the 1000 random data sets
H2 = plot(Age,Corr_Raw_All_Male,'LineWidth',My_LineWidth,'Color',My_Colors_4_1(1,:)); % linear correlation coefficient of the raw data sets
