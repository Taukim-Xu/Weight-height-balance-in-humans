...
xlswrite('SHARE_ALL.xlsx',Save_data_Female,'Female','B2');
xlswrite('SHARE_ALL.xlsx',Save_data_Male,'Male','B2');
xlswrite('SHARE_ALL.xlsx',Save_data,'ALL','C2');
