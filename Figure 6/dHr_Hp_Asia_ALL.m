%% Source codes for dHr_Hp_Asia_ALL.m
tic;
%%
c = 1;
...
dHr_Hp_Asia_ALL_Female = []; % Wr - Wp: The real weight minus the weight predicted by the model
dHr_Hp_Asia_ALL_Male = []; % Wr - Wp: The real weight minus the weight predicted by the model
...
[M N] = size(X_Temp);
for i = 1:M
    dHr_Hp_Asia_ALL_Female = [dHr_Hp_Asia_ALL_Female X_Temp(i) - (Y_Temp(i)-Coefficient_a)/(Coefficient_b*Y_Temp(i))]; % Hr - Hp
end
Age = 51;
...
[M N] = size(X_Temp);
for i = 1:M
    dHr_Hp_Asia_ALL_Male = [dHr_Hp_Asia_ALL_Male X_Temp(i) - (Y_Temp(i)-Coefficient_a)/(Coefficient_b*Y_Temp(i))]; % Hr - Hp
end
Age = 51;
...
toc;
%% We save the data
save dHr_Hp_Asia_ALL.mat dHr_Hp_Asia_ALL_Female dHr_Hp_Asia_ALL_Male
