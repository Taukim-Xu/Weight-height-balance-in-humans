...
xlswrite('NHANES_ALL.xlsx',Save_data_Female,'Female','C2');
xlswrite('NHANES_ALL.xlsx',Save_data_Male,'Male','C2');
xlswrite('NHANES_ALL.xlsx',Save_data,'ALL','C2');
