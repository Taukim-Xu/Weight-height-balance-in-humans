...
%% 01-NHANES
Female_data = xlsread('./Raw_data/01-NHANES/NHANES_ALL.xlsx','Female','C:E'); % Age	Height(cm)	Weight(Kg)
Male_data = xlsread('./Raw_data/01-NHANES/NHANES_ALL.xlsx','Male','C:E'); % Age	Height(cm)	Weight(Kg)
...
Age_Total_ALL = 1:90;
Low_lim_Wt_Total_ALL_Female = []; % Wt = a
Low_lim_Wt_Total_ALL_Male = [];
UPP_lim_Ht_Total_ALL_Female = []; % Ht = 1/b
UPP_lim_Ht_Total_ALL_Male = [];
...
Low_lim_Wt_Total_ALL_Female = [Low_lim_Wt_Total_ALL_Female PP(2)];
UPP_lim_Ht_Total_ALL_Female = [UPP_lim_Ht_Total_ALL_Female 1/PP(1)];
% Aged 2
...
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
PP = polyfit(Z_data,X_data,1); %  Weight = a + b*Weight*Height
Low_lim_Wt_Total_ALL_Male = [Low_lim_Wt_Total_ALL_Male PP(2)];
UPP_lim_Ht_Total_ALL_Male = [UPP_lim_Ht_Total_ALL_Male 1/PP(1)];
% Aged 2
...
Low_lim_Wt_America_ALL_Female = []; % Wt = a
Low_lim_Wt_America_ALL_Male = [];
UPP_lim_Ht_America_ALL_Female = []; % Ht = 1/b
UPP_lim_Ht_America_ALL_Male = [];
...
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
PP = polyfit(Z_data,X_data,1); %  Weight = a + b*Weight*Height
Low_lim_Wt_America_ALL_Female = [Low_lim_Wt_America_ALL_Female PP(2)];
UPP_lim_Ht_America_ALL_Female = [UPP_lim_Ht_America_ALL_Female 1/PP(1)];
% Aged 3
X_data = Female_data_3(:,2); % Weight (Kg)
Y_data = Female_data_3(:,1)/100; % Height (m)
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
...
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
PP = polyfit(Z_data,X_data,1); %  Weight = a + b*Weight*Height
Low_lim_Wt_America_ALL_Male = [Low_lim_Wt_America_ALL_Male PP(2)];
UPP_lim_Ht_America_ALL_Male = [UPP_lim_Ht_America_ALL_Male 1/PP(1)];
% Aged 3
X_data = Male_data_3(:,2); % Weight (Kg)
Y_data = Male_data_3(:,1)/100; % Height (m)
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
...
% lower limit for weight and upper limit for height
Age_Asia_ALL = 1:90;
Low_lim_Wt_Asia_ALL_Female = []; % Wt = a
Low_lim_Wt_Asia_ALL_Male = [];
UPP_lim_Ht_Asia_ALL_Female = []; % Ht = 1/b
UPP_lim_Ht_Asia_ALL_Male = [];
...
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
PP = polyfit(Z_data,X_data,1); %  Weight = a + b*Weight*Height
Low_lim_Wt_Asia_ALL_Female = [Low_lim_Wt_Asia_ALL_Female PP(2)];
UPP_lim_Ht_Asia_ALL_Female = [UPP_lim_Ht_Asia_ALL_Female 1/PP(1)];
% Aged 2
X_data = Female_data_2(:,2); % Weight (Kg)
Y_data = Female_data_2(:,1)/100; % Height (m)
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
...
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
PP = polyfit(Z_data,X_data,1); %  Weight = a + b*Weight*Height
Low_lim_Wt_Asia_ALL_Male = [Low_lim_Wt_Asia_ALL_Male PP(2)];
UPP_lim_Ht_Asia_ALL_Male = [UPP_lim_Ht_Asia_ALL_Male 1/PP(1)];
% Aged 2
X_data = Male_data_2(:,2); % Weight (Kg)
Y_data = Male_data_2(:,1)/100; % Height (m)
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
...
Low_lim_Wt_Europe_ALL_Female = []; % Wt = a
Low_lim_Wt_Europe_ALL_Male = [];
UPP_lim_Ht_Europe_ALL_Female = []; % Ht = 1/b
UPP_lim_Ht_Europe_ALL_Male = [];
...
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
PP = polyfit(Z_data,X_data,1); %  Weight = a + b*Weight*Height
Low_lim_Wt_Europe_ALL_Female = [Low_lim_Wt_Europe_ALL_Female PP(2)];
UPP_lim_Ht_Europe_ALL_Female = [UPP_lim_Ht_Europe_ALL_Female 1/PP(1)];
% Aged 51
X_data = Female_data_51(:,2); % Weight (Kg)
Y_data = Female_data_51(:,1)/100; % Height (m)
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
...
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
PP = polyfit(Z_data,X_data,1); %  Weight = a + b*Weight*Height
Low_lim_Wt_Europe_ALL_Male = [Low_lim_Wt_Europe_ALL_Male PP(2)];
UPP_lim_Ht_Europe_ALL_Male = [UPP_lim_Ht_Europe_ALL_Male 1/PP(1)];
% Aged 51
X_data = Male_data_51(:,2); % Weight (Kg)
Y_data = Male_data_51(:,1)/100; % Height (m)
Z_data = X_data.*Y_data; % Weight*Height (Kg.m)
...
Y_data = Low_lim_Wt_Total_ALL_Female;
H1 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(1,:)); 
% Europe_ALL
X_data = Age_Europe_ALL;
Y_data = Low_lim_Wt_Europe_ALL_Female;
H2 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(2,:));
% America_ALL
X_data = Age_America_ALL;
Y_data = Low_lim_Wt_America_ALL_Female;
H3 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(3,:));
% Asia_ALL
X_data = Age_Asia_ALL;
Y_data = Low_lim_Wt_Asia_ALL_Female;
H4 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(4,:));
...
% Total_ALL
X_data = Age_Total_ALL;
Y_data = Low_lim_Wt_Total_ALL_Male;
H1 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(1,:)); 
% Europe_ALL
X_data = Age_Europe_ALL;
Y_data = Low_lim_Wt_Europe_ALL_Male;
H2 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(2,:));
% America_ALL
X_data = Age_America_ALL;
Y_data = Low_lim_Wt_America_ALL_Male;
H3 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(3,:));
% Asia_ALL
X_data = Age_Asia_ALL;
Y_data = Low_lim_Wt_Asia_ALL_Male;
H4 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(4,:));
Legend = legend([H1 H2 H3 H4],'All','Europe','America','Asia','Location','Southeast');
set(Legend,'Box','off')
...
% Total_ALL
X_data = Age_Total_ALL;
Y_data = UPP_lim_Ht_Total_ALL_Female;
H1 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(1,:)); 
% Europe_ALL
X_data = Age_Europe_ALL;
Y_data = UPP_lim_Ht_Europe_ALL_Female;
H2 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(2,:));
% America_ALL
X_data = Age_America_ALL;
Y_data = UPP_lim_Ht_America_ALL_Female;
H3 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(3,:));
% Asia_ALL
X_data = Age_Asia_ALL;
Y_data = UPP_lim_Ht_Asia_ALL_Female;
H4 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(4,:));
Legend = legend([H1 H2 H3 H4],'All','Europe','America','Asia','Location','Southeast');
set(Legend,'Box','off')
...
% Total_ALL
X_data = Age_Total_ALL;
Y_data = UPP_lim_Ht_Total_ALL_Male;
H1 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(1,:)); 
% Europe_ALL
X_data = Age_Europe_ALL;
Y_data = UPP_lim_Ht_Europe_ALL_Male;
H2 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(2,:));
% America_ALL
X_data = Age_America_ALL;
Y_data = UPP_lim_Ht_America_ALL_Male;
H3 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(3,:));
% Asia_ALL
X_data = Age_Asia_ALL;
Y_data = UPP_lim_Ht_Asia_ALL_Male;
H4 = plot(X_data,Y_data,'linewidth',My_LineWidth,'Color',My_Colors_4_1(4,:));
Legend = legend([H1 H2 H3 H4],'All','Europe','America','Asia','Location','Southeast');
set(Legend,'Box','off')
...
% We save the data
save('Figure_3_A.mat',...
    'Age_Total_ALL','Low_lim_Wt_Total_ALL_Female','Low_lim_Wt_Total_ALL_Male',...
    'UPP_lim_Ht_Total_ALL_Female','UPP_lim_Ht_Total_ALL_Male',...
    'Age_America_ALL','Low_lim_Wt_America_ALL_Female','Low_lim_Wt_America_ALL_Male',...
    'UPP_lim_Ht_America_ALL_Female','UPP_lim_Ht_America_ALL_Male',...
    'Age_Asia_ALL','Low_lim_Wt_Asia_ALL_Female','Low_lim_Wt_Asia_ALL_Male',...
    'UPP_lim_Ht_Asia_ALL_Female','UPP_lim_Ht_Asia_ALL_Male',...
    'Age_Europe_ALL','Low_lim_Wt_Europe_ALL_Female','Low_lim_Wt_Europe_ALL_Male',...
