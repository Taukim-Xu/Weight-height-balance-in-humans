...
Male_data = [];
%% Total_All
Female_data_temp = xlsread('./Raw data/Total_All.xlsx','Female'); % No.	Age	Height(cm)	Weight(Kg)
Male_data_temp = xlsread('./Raw data/Total_All.xlsx','Male'); % No. Age	Height(cm)	Weight(Kg)
