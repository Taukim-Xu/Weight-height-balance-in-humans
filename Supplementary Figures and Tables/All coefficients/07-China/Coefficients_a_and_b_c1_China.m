...
% 
% Including:
% Jilin_China （7岁至18岁） - 吉林，中国
% Chongqing_6_21_China - 重庆，中国
% BCCPDS_7_21_China - 全国，中国
% CHARLS_ALL (41岁至87岁） - 全国，中国
% China_ALL （6至21岁，41岁至87岁） - 所有的中国数据
% 
%
%%
c = 1;
...
%% CHARLS All.xlsx
% Loading the data
Female_data = xlsread('CHARLS All.xlsx','Female');
Male_data = xlsread('CHARLS All.xlsx','Male');
% Grouping by age
Female_data_41 = [];
Female_data_42 = [];
Female_data_43 = [];
...
for i = 1:M
    ...
    if Female_data(i,2) == 86
        Female_data_86 = [Female_data_86; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 87
        Female_data_87 = [Female_data_87; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
end
% For Male
[M N] = size(Male_data); % No.	Age(ys)  Height(cm)	Weight(Kg)
for i = 1:M
    if Male_data(i,2) == 41
    ...
    if Male_data(i,2) == 86
        Male_data_86 = [Male_data_86; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 87
        Male_data_87 = [Male_data_87; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
end

% We calculate the coefficients of a and b in 1=a/Weight+b*Height for this
% dataset
Age_CHARLS_China = 41:87;
Coefficient_a_Female_1_CHARLS_China = [];
Coefficient_b_Female_1_CHARLS_China = [];
Coefficient_a_Male_1_CHARLS_China = [];
Coefficient_b_Male_1_CHARLS_China = [];
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Female_1_CHARLS_China = [Coefficient_a_Female_1_CHARLS_China PP(2)];
Coefficient_b_Female_1_CHARLS_China = [Coefficient_b_Female_1_CHARLS_China PP(1)];
% Age 42
...
Z_data= X_data.*Y_data; % Height^c*Weight
PP = polyfit(Z_data,Y_data,1); % linear fitting
Coefficient_a_Male_1_CHARLS_China = [Coefficient_a_Male_1_CHARLS_China PP(2)];
Coefficient_b_Male_1_CHARLS_China = [Coefficient_b_Male_1_CHARLS_China PP(1)];
% Age 42
...
HH1 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',My_Colors_4_1(1,:),'MarkerFaceColor','w');

% Chongqing_6_21_China
x_data = Age_Chongqing_6_21_China;
y_data = Coefficient_a_Female_1_Chongqing_6_21_China;
HH2 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',My_Colors_4_1(2,:),'MarkerFaceColor','w');

% BCCPDS_7_21_China
x_data = Age_BCCPDS_7_21_China;
y_data = Coefficient_a_Female_1_BCCPDS_7_21_China;
HH3 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',My_Colors_4_1(3,:),'MarkerFaceColor','w');

% CHARLS_ALL
x_data = Age_CHARLS_China;
y_data = Coefficient_a_Female_1_CHARLS_China;
HH4 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',My_Colors_4_1(4,:),'MarkerFaceColor','w');
...
% CHARLS_ALL
x_data = Age_CHARLS_China;
y_data = Coefficient_b_Female_1_CHARLS_China;
HH4 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',My_Colors_4_1(4,:),'MarkerFaceColor','w');
...
% For Male
subplot(2,2,2); % Coefficient a for female
hold on;
title('Male')
xlabel('Age (yr)');
ylabel('Coefficient a')
...
% CHARLS_ALL
x_data = Age_CHARLS_China;
y_data = Coefficient_a_Male_1_CHARLS_China;
HH4 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',My_Colors_4_1(4,:),'MarkerFaceColor','w');

subplot(2,2,4); % Coefficient b for female
hold on;
title('Male')
xlabel('Age (yr)');
ylabel('Coefficient b')
...
% CHARLS_ALL
x_data = Age_CHARLS_China;
y_data = Coefficient_b_Male_1_CHARLS_China;
HH4 = plot(x_data,y_data,'-','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',My_Colors_4_1(4,:),'MarkerFaceColor','w');
...
save('Coefficients_a_and_b_c1_China.mat',...
    ...
    'Age_CHARLS_China','Coefficient_a_Female_1_CHARLS_China','Coefficient_b_Female_1_CHARLS_China',...
    'Coefficient_a_Male_1_CHARLS_China','Coefficient_b_Male_1_CHARLS_China');
