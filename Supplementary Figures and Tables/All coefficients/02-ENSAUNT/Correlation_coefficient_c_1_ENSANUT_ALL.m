...
% all ENSANUT datasets when exponent c = 1;
% Including:
% ENSANUT 2006
% ENSANUT 2012
% ENSANUT 2016
...
% For Female
[M N] = size(Female_data); % No.	Age(ys)	Weight(Kg)	Height(cm)
for i = 1:M
    if Female_data(i,2) == 1
        Female_data_1 = [Female_data_1; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 2
        Female_data_2 = [Female_data_2; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 3
        Female_data_3 = [Female_data_3; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 4
        Female_data_4 = [Female_data_4; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 5
        Female_data_5 = [Female_data_5; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 6
        Female_data_6 = [Female_data_6; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 7
        Female_data_7 = [Female_data_7; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 8
        Female_data_8 = [Female_data_8; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 9
        Female_data_9 = [Female_data_9; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 10
        Female_data_10 = [Female_data_10; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 11
        Female_data_11 = [Female_data_11; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 12
        Female_data_12 = [Female_data_12; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 13
        Female_data_13 = [Female_data_13; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 14
        Female_data_14 = [Female_data_14; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 15
        Female_data_15 = [Female_data_15; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 16
        Female_data_16 = [Female_data_16; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 17
        Female_data_17 = [Female_data_17; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 18
        Female_data_18 = [Female_data_18; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 19
        Female_data_19 = [Female_data_19; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 20
        Female_data_20 = [Female_data_20; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 21
        Female_data_21 = [Female_data_21; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 22
        Female_data_22 = [Female_data_22; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 23
        Female_data_23 = [Female_data_23; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 24
        Female_data_24 = [Female_data_24; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 25
        Female_data_25 = [Female_data_25; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 26
        Female_data_26 = [Female_data_26; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 27
        Female_data_27 = [Female_data_27; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 28
        Female_data_28 = [Female_data_28; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 29
        Female_data_29 = [Female_data_29; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 30
        Female_data_30 = [Female_data_30; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 31
        Female_data_31 = [Female_data_31; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 32
        Female_data_32 = [Female_data_32; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 33
        Female_data_33 = [Female_data_33; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 34
        Female_data_34 = [Female_data_34; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    ...
    if Female_data(i,2) == 75
        Female_data_75 = [Female_data_75; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 76
        Female_data_76 = [Female_data_76; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 77
        Female_data_77 = [Female_data_77; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 78
        Female_data_78 = [Female_data_78; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 79
        Female_data_79 = [Female_data_79; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 80
        Female_data_80 = [Female_data_80; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 81
        Female_data_81 = [Female_data_81; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 82
        Female_data_82 = [Female_data_82; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 83
        Female_data_83 = [Female_data_83; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 84
        Female_data_84 = [Female_data_84; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Female_data(i,2) == 85
        Female_data_85 = [Female_data_85; Female_data(i,3) Female_data(i,4)]; % Height(cm) Weight(Kg)
    end
end
% For Male
...
for i = 1:M
    if Male_data(i,2) == 1
        Male_data_1 = [Male_data_1; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 2
        Male_data_2 = [Male_data_2; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 3
        Male_data_3 = [Male_data_3; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 4
        Male_data_4 = [Male_data_4; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 5
        Male_data_5 = [Male_data_5; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 6
        Male_data_6 = [Male_data_6; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 7
        Male_data_7 = [Male_data_7; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 8
        Male_data_8 = [Male_data_8; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 9
        Male_data_9 = [Male_data_9; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 10
        Male_data_10 = [Male_data_10; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 11
        Male_data_11 = [Male_data_11; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 12
        Male_data_12 = [Male_data_12; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 13
        Male_data_13 = [Male_data_13; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 14
        Male_data_14 = [Male_data_14; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 15
        Male_data_15 = [Male_data_15; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 16
        Male_data_16 = [Male_data_16; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 17
        Male_data_17 = [Male_data_17; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 18
        Male_data_18 = [Male_data_18; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 19
        Male_data_19 = [Male_data_19; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 20
        Male_data_20 = [Male_data_20; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 21
        Male_data_21 = [Male_data_21; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 22
        Male_data_22 = [Male_data_22; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 23
        Male_data_23 = [Male_data_23; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 24
        Male_data_24 = [Male_data_24; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 25
        Male_data_25 = [Male_data_25; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 26
        Male_data_26 = [Male_data_26; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 27
        Male_data_27 = [Male_data_27; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 28
        Male_data_28 = [Male_data_28; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 29
        Male_data_29 = [Male_data_29; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 30
        Male_data_30 = [Male_data_30; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 31
        Male_data_31 = [Male_data_31; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 32
        Male_data_32 = [Male_data_32; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 33
        Male_data_33 = [Male_data_33; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 34
        Male_data_34 = [Male_data_34; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 35
    ...
    if Male_data(i,2) == 75
        Male_data_75 = [Male_data_75; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 76
        Male_data_76 = [Male_data_76; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 77
        Male_data_77 = [Male_data_77; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 78
        Male_data_78 = [Male_data_78; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 79
        Male_data_79 = [Male_data_79; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 80
        Male_data_80 = [Male_data_80; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 81
        Male_data_81 = [Male_data_81; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 82
        Male_data_82 = [Male_data_82; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 83
        Male_data_83 = [Male_data_83; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 84
        Male_data_84 = [Male_data_84; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
    if Male_data(i,2) == 85
        Male_data_85 = [Male_data_85; Male_data(i,3) Male_data(i,4)]; % Height(cm) Weight(Kg)
    end
end
% We calculate the correlation coefficients
% Weight VS Weight*Height^c
Age_1_ENSANUT_2006 = 1:85;
Corr_1_ENSANUT_2006_Female = [...
...
% We calculate the correlation coefficients
% Weight VS Weight*Height^c
Age_1_ENSANUT_2012 = 1:85;
Corr_1_ENSANUT_2012_Female = [...
    My_Corr(Female_data_1(:,2),Female_data_1(:,2).*(Female_data_1(:,1)/100).^c) ...
    My_Corr(Female_data_2(:,2),Female_data_2(:,2).*(Female_data_2(:,1)/100).^c) ...
    My_Corr(Female_data_3(:,2),Female_data_3(:,2).*(Female_data_3(:,1)/100).^c) ...
    My_Corr(Female_data_4(:,2),Female_data_4(:,2).*(Female_data_4(:,1)/100).^c) ...
...
% We calculate the correlation coefficients
% Weight VS Weight*Height^c
Age_1_ENSANUT_2016 = 1:80;
Corr_1_ENSANUT_2016_Female = [...
    My_Corr(Female_data_1(:,2),Female_data_1(:,2).*(Female_data_1(:,1)/100).^c) ...
    My_Corr(Female_data_2(:,2),Female_data_2(:,2).*(Female_data_2(:,1)/100).^c) ...
    My_Corr(Female_data_3(:,2),Female_data_3(:,2).*(Female_data_3(:,1)/100).^c) ...
    My_Corr(Female_data_4(:,2),Female_data_4(:,2).*(Female_data_4(:,1)/100).^c) ...
...
% We calculate the correlation coefficients
% Weight VS Weight*Height^c
Age_1_ENSANUT_2018 = 1:59;
Corr_1_ENSANUT_2018_Female = [...
    My_Corr(Female_data_1(:,2),Female_data_1(:,2).*(Female_data_1(:,1)/100).^c) ...
    My_Corr(Female_data_2(:,2),Female_data_2(:,2).*(Female_data_2(:,1)/100).^c) ...
    My_Corr(Female_data_3(:,2),Female_data_3(:,2).*(Female_data_3(:,1)/100).^c) ...
    My_Corr(Female_data_4(:,2),Female_data_4(:,2).*(Female_data_4(:,1)/100).^c) ...
...
% We calculate the correlation coefficients
% Weight VS Weight*Height^c
Age_1_ENSANUT_100K_2018 = 1:80;
Corr_1_ENSANUT_100K_2018_Female = [...
    My_Corr(Female_data_1(:,2),Female_data_1(:,2).*(Female_data_1(:,1)/100).^c) ...
    My_Corr(Female_data_2(:,2),Female_data_2(:,2).*(Female_data_2(:,1)/100).^c) ...
    My_Corr(Female_data_3(:,2),Female_data_3(:,2).*(Female_data_3(:,1)/100).^c) ...
    My_Corr(Female_data_4(:,2),Female_data_4(:,2).*(Female_data_4(:,1)/100).^c) ...
...
%% ENSANUT ALL.xlsx
% Loading the data
Female_data = xlsread('Data_ENSANUT\ENSANUT ALL.xlsx','Female');
Male_data = xlsread('Data_ENSANUT\ENSANUT ALL.xlsx','Male');
% Grouping by age
Female_data_1 = [];
Female_data_2 = [];
Female_data_3 = [];
...
Legend = legend([HH1 HH2 HH3 HH4 HH5 HH6],...
    ...
    'ENSANUT 2018','ENSANUT 100K 2018',...
    'ENSANUT ALL'});
set(Legend,'Box','off','location','SouthEast')

%%
% We save the correlation analysis results
save('Correlation_coefficient_c_1_ENSANUT_ALL.mat','Age_1_ENSANUT_2006','Corr_1_ENSANUT_2006_Female','Corr_1_ENSANUT_2006_Male',...
    'Age_1_ENSANUT_2012','Corr_1_ENSANUT_2012_Female','Corr_1_ENSANUT_2012_Male',...
    'Age_1_ENSANUT_2016','Corr_1_ENSANUT_2016_Female','Corr_1_ENSANUT_2016_Male',...
    'Age_1_ENSANUT_2018','Corr_1_ENSANUT_2018_Female','Corr_1_ENSANUT_2018_Male',...
    'Age_1_ENSANUT_100K_2018','Corr_1_ENSANUT_100K_2018_Female','Corr_1_ENSANUT_100K_2018_Male',...
    'Age_1_ENSANUT_ALL','Corr_1_ENSANUT_ALL_Female','Corr_1_ENSANUT_ALL_Male');
%}