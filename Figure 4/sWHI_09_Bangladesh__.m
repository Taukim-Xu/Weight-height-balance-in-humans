%% Source codes for sWHI_09_Bangladesh__.mat
...
%% ENSANUT ALL
sWHI_Female_09_Bangladesh_All__ = []; % For all ages
sWHI_Male_09_Bangladesh_All__ = []; % For all ages
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Female_09_Bangladesh_All__ = [sWHI_Female_09_Bangladesh_All__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
% Age = 11;
...
%% We save the data 
save sWHI_09_Bangladesh__.mat sWHI_Female_09_Bangladesh_All__
