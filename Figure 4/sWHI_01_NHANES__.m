%% Source codes for sWHI_01_NHANES__.mat
...
%% NHANES_ALL
sWHI_Female_01_NHANES_All__ = []; % For all ages
sWHI_Male_01_NHANES_All__ = []; % For all ages
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Female_01_NHANES_All__ = [sWHI_Female_01_NHANES_All__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
% Age = 3;
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Male_01_NHANES_All__ = [sWHI_Male_01_NHANES_All__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
% Age = 3;
...
%% We save the data 
save sWHI_01_NHANES__.mat sWHI_Female_01_NHANES_All__ sWHI_Male_01_NHANES_All__
