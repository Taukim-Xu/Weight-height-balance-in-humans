%% Source codes for sWHI_02_ENSAUNT__.mat
...
%% ENSANUT ALL
sWHI_Female_02_ENSAUNT_All__ = []; % For all ages
sWHI_Male_02_ENSAUNT_All__ = []; % For all ages
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Female_02_ENSAUNT_All__ = [sWHI_Female_02_ENSAUNT_All__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
% Age = 2;
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Male_02_ENSAUNT_All__ = [sWHI_Male_02_ENSAUNT_All__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
% Age = 2;
...
%% We save the data 
save sWHI_02_ENSAUNT__.mat sWHI_Female_02_ENSAUNT_All__ sWHI_Male_02_ENSAUNT_All__
