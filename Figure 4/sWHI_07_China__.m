%% Source codes for sWHI_07_China__.mat
...
sWHI_Female_07_China_All__ = []; % For all ages
sWHI_Male_07_China_All__ = []; % For all ages

%% Jilin_China
Female_data = xlsread('./Raw data/07-China/Jilin_China.xlsx','Female','B:D');
Male_data = xlsread('./Raw data/07-China/Jilin_China.xlsx','Male','B:D');
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Female_07_China_All__ = [sWHI_Female_07_China_All__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
% Age = 8;
...
[M N] = size(X_Temp);
for i = 1:M
    sWHI_Male_07_China_All__ = [sWHI_Male_07_China_All__ Coefficient_a/Y_Temp(i)+Coefficient_b*X_Temp(i)^c]; % a/Weight+b*Height
end
% Age = 8;
...
Female_data = xlsread('./Raw data/07-China/Chongqing_6_21_China.xlsx','Female','B:D');
Male_data = xlsread('./Raw data/07-China/Chongqing_6_21_China.xlsx','Male','B:D');
...
%% BCCPDS_7_21_China
Female_data = xlsread('./Raw data/07-China/BCCPDS_7_21_China.xlsx','Female','B:D');
Male_data = xlsread('./Raw data/07-China/BCCPDS_7_21_China.xlsx','Male','B:D');
...
Female_data = xlsread('./Raw data/07-China/CHARLS All.xlsx','Female','B:D');
Male_data = xlsread('./Raw data/07-China/CHARLS All.xlsx','Male','B:D');
...
%% We save the data 
save sWHI_07_China__.mat sWHI_Female_07_China_All__ sWHI_Male_07_China_All__
